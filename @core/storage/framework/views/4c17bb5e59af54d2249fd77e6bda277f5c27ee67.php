                        ...
                        <form action="<?php echo e(route('admin.maintains.page.settings')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="maintain_page_countdown" class="form-control flatpickr" value="<?php echo e(get_static_option('maintain_page_countdown')); ?>">
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u363353642/domains/froshgah.store/public_html/@core/resources/views/backend/pages/maintain-page/maintain-page-index.blade.php ENDPATH**/ ?>