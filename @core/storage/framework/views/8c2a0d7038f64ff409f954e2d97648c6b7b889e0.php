...
<div class="page-container">
                ...
                <div class="col-md-6 col-sm-4 clearfix">
                    <ul class="notification-area pull-right">
                        <li ><label class="switch yes">
                            ...
                            <span class="slider-yes-no darkmode onff"></span>
                        </label></li>
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">v-<?php echo e(get_static_option('site_script_version','2.0.6')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH /home/u363353642/domains/froshgah.store/public_html/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>