...
$imageUploadRoute = $imageUploadRoute ?? route('admin.upload.media.file');
$deleteIcon = isset($imageUploadRoute) ? 'fas fa-trash' : 'ti-trash';
?>
                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <a tabindex="0" style="display: none" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1" id="media_library_image_delete_btn" >
                                            <i class="<?php echo e($deleteIcon); ?>"></i>
                                        </a>
                                    </div>
                                </div>
...
<?php /**PATH /home/u363353642/domains/froshgah.store/public_html/@core/resources/views/components/media/markup.blade.php ENDPATH**/ ?>