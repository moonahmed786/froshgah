                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="site_default_payment_gateway" class="form-control" >
                                            @php
                                                $all_gateways = ['paypal','manual_payment','mollie','paytm','stripe','razorpay','flutterwave','paystack','midtrans','marcado_pago','instamojo','cashfree','payfast'];
                                            @endphp
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="paypal_settings_content" class="collapse show"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="paypal_payment_action">{{__('Paypal Payment Action')}}</label>
                                                            <input type="text" name="paypal_payment_action"
                                                                   class="form-control"
                                                                   value="{{get_static_option('paypal_payment_action')}}">
                                                        </div>
{{--                                                        <div class="form-group">--}}
...
{{--                                                                @foreach(script_currency_list() as $cur => $symbol)--}}
{{--                                                                    <option value="{{$cur}}"--}}
{{--                                                                            @if(get_static_option('paypal_currency') == $cur) selected @endif>{{$cur.' ( '.$symbol.' )'}}</option>--}}
{{--                                                                @endforeach--}}
{{--                                                            </select>--}}
{{--                                                        </div>--}}

{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="paypal_notify_url">{{__('Paypal Notify URL')}}</label>--}}
{{--                                                            <input type="text" name="paypal_notify_url"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   value="{{get_static_option('paypal_notify_url')}}">--}}
{{--                                                        </div>--}}
{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="paypal_locale">{{__('Paypal Locale')}}</label>--}}
{{--                                                            <input type="text" name="paypal_locale"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   value="{{get_static_option('paypal_locale')}}">--}}
{{--                                                        </div>--}}

{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="paypal_validate_ssl">{{__('Paypal Validate SSL')}}</label>--}}
{{--                                                            <input type="text" name="paypal_validate_ssl"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   value="{{get_static_option('paypal_validate_ssl')}}">--}}
{{--                                                        </div>--}}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="bank_payment_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                data-toggle="collapse"
                                                                data-target="#bank_payment_settings_content"
                                                                aria-expanded="false">
                                                            <span class="page-title"> {{__('Bank Payment Settings')}}</span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="bank_payment_settings_content" class="collapse"
                                                     data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="bank_payment_gateway"><strong>{{__('Enable/Disable Bank Payment')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="bank_payment_gateway"
                                                                       @if(!empty(get_static_option('bank_payment_gateway'))) checked
                                                                       @endif id="bank_payment_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong>{{__('Bank Payment Logo')}}</strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    @php
                                                                        $paytm_img = get_attachment_image_by_id(get_static_option('bank_payment_preview_logo'),null,false);
                                                                        $paytm_image_btn_label = __('Upload Image');
                                                                    @endphp
                                                                    @if (!empty($paytm_img))
                                                                        <div class="attachment-preview">
                                                                ...
                                                                <input type="hidden" id="bank_payment_preview_logo"
                                                                       name="bank_payment_preview_logo"
                                                                       value="{{get_static_option('bank_payment_preview_logo')}}">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="{{__('Select Image')}}"
                                                                        data-modaltitle="{{__('Upload Image')}}"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_bank_payment_name">{{__('Bank Payment Name')}}</label>
                                                            <input type="text" name="site_bank_payment_name"
                                                                   id="site_bank_payment_name"
                                                                   value="{{get_static_option('site_bank_payment_name')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_bank_payment_description">{{__('Bank Payment Description')}}</label>
                                                            <input type="hidden" name="site_bank_payment_description" value="{{get_static_option('site_bank_payment_description')}}">
                                                            <div class="summernote" data-content='{{get_static_option('site_bank_payment_description')}}'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
