 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\ZaikaMacroServiceProvider::boot()
         * @param mixed $value
         * @static 
         */ 
        public static function sanitize_html($value)
        {
                        return \Illuminate\Http\Request::sanitize_html($value);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function custom_html($value)
        {
                        return \Illuminate\Http\Request::custom_html($value);
        }
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function via($gateway)
        {
                        /** @var \Tzsk\Payu\Payu $instance */
                        return $instance->via($gateway);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function initiate($payment)
        {
                        /** @var \Tzsk\Payu\Payu $instance */
                        return $instance->initiate($payment);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getSignedRoute($urlType)
        {
                        /** @var \Tzsk\Payu\Payu $instance */
                        return $instance->getSignedRoute($urlType);
        }
