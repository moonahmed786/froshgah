...
class HeaderSliderFive extends PageBuilderBase
{
    use RepeaterHelper;
    /**
     * preview_image
    ...
    public function admin_render()
    {
        ...
        $output .= Text::get([
            ...
            'value' => $widget_saved_values['sidebar_title'] ?? '',
        ]);
    ...
    public function frontend_render(): string
    {
        ...
        $title = SanitizeInput::esc_html($all_settings['sidebar_title']);
        $category = SanitizeInput::esc_html($all_settings['category_menu']);
